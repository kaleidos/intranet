...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Talk'
        db.create_table(u'intranet_talk', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('obsolete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'intranet', ['Talk'])

        # Adding M2M table for field wanters on 'Talk'
        m2m_table_name = db.shorten_name(u'intranet_talk_wanters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('talk', models.ForeignKey(orm[u'intranet.talk'], null=False)),
            ('user', models.ForeignKey(orm[u'intranet.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['talk_id', 'user_id'])

        # Adding M2M table for field talkers on 'Talk'
        m2m_table_name = db.shorten_name(u'intranet_talk_talkers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('talk', models.ForeignKey(orm[u'intranet.talk'], null=False)),
            ('user', models.ForeignKey(orm[u'intranet.user'], null=False))
    ...
    def backwards(self, orm):
        # Deleting model 'Talk'
        db.delete_table(u'intranet_talk')

        # Removing M2M table for field wanters on 'Talk'
        db.delete_table(db.shorten_name(u'intranet_talk_wanters'))

        # Removing M2M table for field talkers on 'Talk'
        db.delete_table(db.shorten_name(u'intranet_talk_talkers'))
    ...
    models = {
        ...
        u'intranet.talk': {
            ...
            'talkers': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'related_name': "'talks_offers'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['intranet.User']"}),
            'wanters': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'related_name': "'talks_wanted'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['intranet.User']"})
        },
        u'intranet.user': {
