...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Talk.datetime'
        db.delete_column(u'intranet_talk', 'datetime')

        # Adding field 'Talk.event_date'
        db.add_column(u'intranet_talk', 'event_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Talk.datetime'
        db.add_column(u'intranet_talk', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Talk.event_date'
        db.delete_column(u'intranet_talk', 'event_date')
