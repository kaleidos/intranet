...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Talk.created_date'
        db.add_column(u'intranet_talk', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Talk.created_date'
        db.delete_column(u'intranet_talk', 'created_date')
