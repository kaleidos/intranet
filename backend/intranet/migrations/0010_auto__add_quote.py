...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'intranet_quote', (
            ...
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quotes', null=True, to=orm['intranet.User'])),
            ('external_author', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quotes_created', null=True, to=orm['intranet.User'])),
        ))
        db.send_create_signal(u'intranet', ['Quote'])


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'intranet_quote')
