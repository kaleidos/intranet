...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuoteScore'
        db.create_table(u'intranet_quotescore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_scores', to=orm['intranet.User'])),
            ('quote', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scores', to=orm['intranet.Quote'])),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'intranet', ['QuoteScore'])

        # Adding unique constraint on 'QuoteScore', fields ['user', 'quote']
        db.create_unique(u'intranet_quotescore', ['user_id', 'quote_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuoteScore', fields ['user', 'quote']
        db.delete_unique(u'intranet_quotescore', ['user_id', 'quote_id'])

        # Deleting model 'QuoteScore'
        db.delete_table(u'intranet_quotescore')
